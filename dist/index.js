...
var hackkey_1 = __importDefault(require("./hackkey"));
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var store, item3, item4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                store = (0, hackkey_1.default)();
            ...
            case 1:
                _a.sent();
                item3 = store.set({ key: 'todelete', value: { id: 3 }, ttl: 2000 });
                store.del('todelete');
                console.log('item3 does not exist', !store.get('todelete'));
                item4 = store.set({ key: 'toupdate', value: { id: 4 }, ttl: 1000 });
